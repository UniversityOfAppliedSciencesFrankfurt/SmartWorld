...
namespace MQTTSnBroker
{
    public class Publisher
    {
        ...
        public static int Insert(Publish publish, SqliteConnection sConnect)
        {
        ...
        public static List<PublishWrk> GetPublishbyClient(byte[] clientId, SqliteConnection sConnect)
        {
            ...
            List<PublishWrk> retPublishers = new List<PublishWrk>();
            while (reader.Read())
            {
                PublishWrk pubs = new PublishWrk();
